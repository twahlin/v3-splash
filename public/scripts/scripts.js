    ...
    var timer = {
      ...
      update_based_on: function(type, obj) {
        ...
        var update = setInterval(function() {
          obj.animate({arc: [100, 100, timer.get_arc_radius(), 100, 80]}, types[type], "bounce");  
        }, types[type])
      },
      //
      // `create_pieces`
      ...
      create_pieces: function() {
        ...
        var my_arc = archtype.path().attr({"stroke": "#ff00bb", "stroke-width": 25, arc: [100, 100, timer.get_arc_radius(), 100, 80]});
